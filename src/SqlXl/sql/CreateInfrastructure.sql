...
BEGIN
	...
	--Menu item for InsertONE via Form editor...
	select 
	[DisplayName] = replace(f.UserFriendlyFeatureName,'- Bulk Grid','- Quick Form')
	,[ControllerName] = 'Home'
	...
	-- Insert-features...
	SELECT 
        DisplayName = UserFriendlyFeatureName,
        ControllerName = 'Home',
        ActionName = 'GetStartingPointData',
	...
	select 
		[DisplayName] = replace(f.UserFriendlyFeatureName,'- Bulk Grid','- Import File')
		,[ControllerName] = 'Home'
	...
	--Update-features call GetRowsToChooseFrom...
	SELECT 
        DisplayName = UserFriendlyFeatureName,
        ControllerName = 'Home',
        ActionName = 'GetRowsToChooseFrom',
        QueryString = '&featureID=' + convert(nvarchar, ID),
        SortOrder = 300 
    FROM 
        SqlXl.BulkOpFeatures
	...
	--Update-feature to go straight to excel upload...
	SELECT 
       DisplayName = UserFriendlyFeatureName + ' - Import Prepared File',
        ControllerName = 'Home',
        ActionName = 'FileUploadScreen',
        QueryString = '&featureID=' + convert(nvarchar, ID),
        SortOrder = 310
	...
	--Tack on the ZZDev options...
	select 
		[DisplayName] = 'ZZDev - Test Database Connection'
		,[ControllerName] = 'Home'
		,[ActionName] = 'DbConnTest'
		,[QueryString] = ''
		,[SortOrder] = 1000
	...
	select 
		[DisplayName] = 'ZZDev - Select-Query Console'
		,[ControllerName] = 'Home'
		,[ActionName] = 'DeveloperConsole'
		,[QueryString] = ''
		,[SortOrder] = 1100
	...
	select 
		[DisplayName] = 'ZZDev - Examples and Styling'
		,[ControllerName] = 'Home'
		,[ActionName] = 'Examples'
		,[QueryString] = ''
		,[SortOrder] = 1200

	--union --ToDo, complete the online-select-statement-quick-editor
	--select --************************
	--	[DisplayName] = 'ZZDev - Edit GetRowsToEdit_SelectStatement - ' + f.UserFriendlyFeatureName
	--	,[ControllerName] = 'Home'
